...
export default function FinanceiroPessoalLancamentosPage() {
  ...
  const [competencyDate, setCompetencyDate] = useState(todayInputValue());
  ...
  function resetForm() {
    ...
    setPaidAt("");
    setCompetencyDate(todayInputValue());
    setAccountId("");
    setCategoryId("");
    setCounterpartyName("");
    setNotes("");
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      const payload = {
        ...
        paid_at: paidAt || null,
        competency_date: competencyDate || null,
  ...
  function handleEdit(row: FinancialTransaction) {
    ...
    setCompetencyDate(row.competency_date ?? "");
  ...
  const filteredCategories = useMemo(() => {
    return categories.filter((c) => c.type === "both" || c.type === kind);
  }, [categories, kind]);
        ...
        >
          ...
          <div style={{ gridColumn: "span 2" }}>
            ...
            <input
              ...
              style={inputStyle}
              placeholder="Ex.: Salário / Mercado / Conta telefone"
            />
          </div>
          ...
          <div>
            <label style={labelStyle}>Conta / Carteira</label>
            <SelectDark
              value={accountId}
