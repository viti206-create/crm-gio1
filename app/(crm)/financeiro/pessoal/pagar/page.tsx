...
export default function FinanceiroPessoalPagarPage() {
  ...
  async function handlePay(row: FinancialTransaction) {
    try {
      ...
      console.error(e);
      setErrorMsg(e?.message ?? "Erro ao marcar como pago.");
    }
  }
  ...
  const summary = useMemo(() => {
    ...
    return { total, pending, paid, late };
  }, [filteredRows]);
    ...
    <div style={{ padding: 16, color: "white", display: "grid", gap: 16 }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          <Link href="/financeiro/pessoal/lancamentos" style={btnPrimary}>
            Ir para lançamentos
          </Link>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.04)", borderRadius: 18, padding: 14 }}>
          <div style={{ fontSize: 12, opacity: 0.72 }}>Pagas</div>
          <div style={{ fontSize: 26, fontWeight: 950, marginTop: 6 }}>{formatBRL(summary.paid)}</div>
        </div>
        <div style={{ border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.04)", borderRadius: 18, padding: 14 }}>
      ...
      >
        ...
        >
          <input
            ...
            style={inputStyle}
            placeholder="Buscar descrição, observação, favorecido..."
          />
