...
export default function FinanceiroClinicaPage() {
  ...
  return (
    <div style={pageStyle}>
      ...
      >
        <Link href="/financeiro/clinica/lancamentos" style={cardStyle}>
          <div style={{ fontSize: 18, fontWeight: 900 }}>Lançamentos</div>
          <div style={{ opacity: 0.8, lineHeight: 1.5 }}>
            Cadastre receitas e despesas da clínica.
          </div>
        </Link>

        <Link href="/financeiro/clinica/pagar" style={cardStyle}>
        ...
        <Link href="/financeiro/clinica/receber" style={cardStyle}>
      ...
      >
        ...
        <div style={{ opacity: 0.78, lineHeight: 1.6 }}>
          Esta área será o dashboard financeiro da clínica. Por enquanto, ela
